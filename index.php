...
<head>
  ...
  <title>BARRELCLUTCH | Flagship Atelier</title>
  <meta name="description" content="Discover Barrelclutch at 181 Mercer Street, NYC. Dedicated to Haute Leathercraft & Bespoke Frame Clutches and artisanal excellence.">
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400..700;1,400..700&family=Plus+Jakarta+Sans:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap">
  <link rel="stylesheet" href="assets/css/style.css">
</head>
<body>
<header class="site-header">
  <div class="container header-inner">
    <a href="index.php" class="brand-logo">BARRELCLUTCH</a>
...
<div class="mobile-drawer" id="mobile-drawer">
  <div class="drawer-header">
    <span class="brand-logo">BARRELCLUTCH</span>
  ...
  <section class="hero" style="border-bottom:1px solid var(--border-subtle); background:linear-gradient(135deg, #120e0b 0%, #1a1410 100%);">
    <div class="container" style="display:grid; grid-template-columns:0.95fr 1.05fr; gap:4.5rem; align-items:center;">
      <div style="order:1;">
        <div style="position:relative; border-radius:var(--radius-md); overflow:hidden; border:2px solid #d9904d44; box-shadow:0 20px 45px rgba(0,0,0,0.6);">
          <img src="assets/images/woven_leather_artisan_tote.jpg" alt="Artisanal hand-woven intrecciato leather tote bag in warm saddle tan" style="width:100%; height:520px; object-fit:cover;">
          <div style="position:absolute; bottom:1.5rem; left:1.5rem; background:rgba(18,14,11,0.88); backdrop-filter:blur(8px); padding:0.6rem 1.2rem; border-radius:var(--radius-sm); border:1px solid var(--border-subtle);">
            <span style="font-family:var(--font-mono); font-size:0.78rem; color:var(--accent-gold); letter-spacing:0.08em; text-transform:uppercase;">Warm Sepia Atelier &bull; 181 Mercer St</span>
          </div>
        </div>
      </div>
      <div style="order:2;">
        <span class="eyebrow" style="color:var(--accent-gold); font-weight:600;">Warm Sepia Atelier &bull; 181 Mercer St</span>
        <h1 style="font-size:3.3rem; line-height:1.16; margin-bottom:1.5rem;">Generational Equilibrium & Artisanal Mastery in Haute Leathercraft & Bespoke Frame Clutches</h1>
        <p style="font-size:1.15rem; color:var(--text-secondary); line-height:1.8; margin-bottom:2.25rem;">Preserving authentic manual disciplines and uncompromising tolerances at 181 Mercer Street, where every bespoke commission transcends industrial manufacturing.</p>
        <div style="display:flex; gap:1.25rem; align-items:center; flex-wrap:wrap;">
          <a href="services.html" class="btn-primary">Explore Commissions</a>
          <a href="about.html" class="btn-secondary">Heritage Lineage</a>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="section-pad">
    <div class="container">
      ...
      <div class="grid-3">
        <div class="card">
          <img src="assets/images/couture_clutch_macro_grain.jpg" alt="Macro detail of full-grain vegetable tanned leather clutch craftsmanship">
          <div class="card-body">
        ...
        <div class="card">
          <img src="assets/images/atelier_leather_bag_curation.jpg" alt="Curated atelier leather handbag collection and polished brass hardware">
          <div class="card-body">
        ...
        <div class="card">
          <img src="assets/images/bespoke_maroquinerie_crafting.jpg" alt="Master artisan hand-stitching saddle leather seams on bespoke handbag">
          <div class="card-body">
  ...
  <section class="section-pad">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Tailored commissions engineered for connoisseurs of Haute Leathercraft & Bespoke Frame Clutches.</p>
      </div>
      <div class="grid-2">
        <div class="card" style="display:grid; grid-template-columns:1fr 1fr; align-items:center;">
          <img src="assets/images/structured_luxury_crossbody.jpg" alt="Structured architectural crossbody bag with braided leather strap accents" style="height:100%; object-fit:cover;">
          <div class="card-body">
        ...
        <div class="card" style="display:grid; grid-template-columns:1fr 1fr; align-items:center;">
          <img src="assets/images/sculptural_evening_hard_case_bag.jpg" alt="Hard-case evening minaudiere clutch with brushed brass locking clasp" style="height:100%; object-fit:cover;">
          <div class="card-body">
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container" style="display:grid; grid-template-columns:1fr 1.1fr; gap:4rem; align-items:center;">
      <div style="display:grid; grid-template-columns:1fr 1fr; gap:1.5rem;">
        <img src="assets/images/mercer_atelier_handbag_display.jpg" alt="Artisanal leather bag showcase at 181 Mercer Street Manhattan boutique" style="border-radius:var(--radius-md); height:280px; width:100%; object-fit:cover;">
        <img src="assets/images/crimson_woven_leather_clutch.jpg" alt="Crimson glazed lambskin braided clutch bag on minimalist pedestal" style="border-radius:var(--radius-md); height:280px; width:100%; object-fit:cover; margin-top:2rem;">
      </div>
      <div>
        <span class="eyebrow">The Atelier Chronicle</span>
        <h2>A Tradition of Patient Hands in the Heart of SoHo</h2>
        <p style="color:var(--text-secondary); line-height:1.8; margin-bottom:1.5rem;">Since our founding at 181 Mercer Street, Barrelclutch has stood as a bastion of tactile discipline. While commercial entities pursue automated shortcuts, our workshop remains committed to the slow, meditative cadence of traditional hand finishing.</p>
        ...
        <table class="spec-table">
          <thead>
            <tr>
              ...
              <th>Our Flagship Atelier (BARRELCLUTCH)</th>
            </tr>
          </thead>
          <tbody>
            <tr>
  ...
  <section class="section-pad" style="background:var(--bg-surface); border-top:1px solid var(--border-subtle); border-bottom:1px solid var(--border-subtle);">
    <div class="container">
      <div class="section-header">
        ...
        <p style="color:var(--text-secondary);">Unsolicited feedback from patrons who demand uncompromised excellence in Haute Leathercraft & Bespoke Frame Clutches.</p>
      </div>
      <div class="grid-3">
        <div class="quote-card">
          <p class="quote-text">"The bespoke execution delivered by Barrelclutch is extraordinary. The tactile feel and flawless balance prove their unwavering adherence to classical hand methods."</p>
...
<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-bottom">
      <span>&copy; 2026 BARRELCLUTCH. All rights reserved. Certified Handcrafted Static Architecture.</span>
